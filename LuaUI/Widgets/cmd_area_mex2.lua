local versionNumber = "v2.01"

function widget:GetInfo()
  return {
    name      = "Area Mex no button v2",
    desc      = versionNumber .. " Adds a command to cap mexes in an area.",
    author    = "Google Frog, NTG",
...
function widget:Initialize()
  ...
  elseif Gname == 'BA' or Gname == 'ca' or Gname == 'nota' then
    Spring.Echo("Area Mex: Loaded for *A")
  ...
  elseif Gname == 'XTA'  then
    ...
    Spring.Echo("Removed Area Mex - unsupported mod")
    widgetHandler:RemoveWidget()
	return
  end
