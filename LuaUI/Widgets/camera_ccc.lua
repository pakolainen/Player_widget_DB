...
function widget:GetInfo()
  return {
    ...
    desc      = "v0.23 Camera featuring 5 actions. Type \255\90\90\255/luaui ccc help\255\255\255\255 for help.",
...
options = {
	...
	helpwindow = {
		...
		value = [[
			...
			Additional actions:
			Keyboard: <arrow keys> replicate middlebutton drag while <pgup/pgdn> replicate mousewheel. You can use these with ctrl/alt/shift modifiers.
	...
	smoothscroll = {
		...
		type = 'bool',
		value = true,
		desc = 'Use smoothscroll method of scrolling.',
	},
	targetmouse = {
